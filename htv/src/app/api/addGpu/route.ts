...
export async function POST(request: Request) {
    ...
    try {
        ...
        const { 
            user_name, address, contact, model_name, pcie, psu, cooling, monitor, 
        ...
        const query = `
            ...
            (user_name, address, contact, model_name, pcie, psu, cooling, monitor, 
            description, image, rest)
            VALUES (${"'" + user_name + "'"}, ${"'" + address+"'"}, ${"'"+contact+"'"}, ${"'"+model_name+"'"}, ${"'"+pcie+"'"}, ${"'"+psu+"'"}, ${"'"+cooling+"'"}, ${"'"+monitor+"'"}, ${"'"+description+"'"}, ${"'"+image+"'"}, ${"'"+rest+"'"}) 
            RETURNING *;
        `;
