...
export default function About() {
    ...
    return (
        ...
        <div className={styles.aboutSection}>
            ...
            <p className={textstyles.bodytext} >Every year more than 30 million computers are thrown out in the US alone while in some parts of the world over 90% of students do not even have access to a digital device. Thousands of online education tools are built to support various educational needs, and create more personalized, inclusive learning experiences. </p>
            <p className={styles.sectitle}>About the project</p>
            <p className={textstyles.bodytext} >
            Our website allows users to easily submit PC components for evaluation. We analyze part compatibility to find the best combinations, reducing logistics costs and improving convenience. Refurbished computers are then donated to schools and individuals in need. Using Neon for our SQL database, we efficiently store and retrieve user and component data, seamlessly integrating it with a dynamic frontend built in React via Next.js. Our biggest challenge was learning new technologies within 36 hours, balancing backend SQL with frontend design. Despite varying experience levels, we worked effectively together, each contributing to the project's success. </p>
